//
//  OpenGLDisplayFillModeViewController.m
//  OpenGLTest
//
//  Created by 苏金劲 on 2020/5/12.
//  Copyright © 2020 苏金劲. All rights reserved.
//

#import "OpenGLDisplayFillModeViewController.h"

#import "OpenGLESUtils.h"

@interface OpenGLDisplayFillModeViewController ()

@end

@implementation OpenGLDisplayFillModeViewController {
...
- (void)viewDidLoad {
    ...
    // 生成顶点
    _vertices = [OpenGLESUtils generateVertices: OpenGLFillMode_AspectRatioFit
                               withDisplayRatio: 0.6
                                  withImageSize: image.size
                               withViewPortSize: viewPortSize];
