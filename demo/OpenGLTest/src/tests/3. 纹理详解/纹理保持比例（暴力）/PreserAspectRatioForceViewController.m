//
//  PreserAspectRatioForceViewController.m
//  OpenGLTest
//
//  Created by 苏金劲 on 2020/5/11.
//  Copyright © 2020 苏金劲. All rights reserved.
//

#import "PreserAspectRatioForceViewController.h"

#import "OpenGLESUtils.h"

@interface PreserAspectRatioForceViewController ()

@end

@implementation PreserAspectRatioForceViewController {
...
static const GLfloat vertices[] = {
    -0.5 * 414.f / 414.f, -0.5 * 414.f / 896.f, 0, // 左下角
    0.5 * 414.f / 414.f, -0.5 * 414.f / 896.f, 0, // 右下角
    -0.5 * 414.f / 414.f, 0.5 * 414.f / 896.f, 0, // 左上角
    0.5 * 414.f / 414.f, 0.5 * 414.f / 896.f, 0 // 右上角
};
