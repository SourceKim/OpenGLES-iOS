...
- (void)viewDidLoad {
    ...
    CGRect rect = [self countRect_AspectFit_Manually: img.size toRect: container.frame];
//    rect = [self countRect_AVfoundation: img.size toRect: container.frame];
//    rect = [self countRect_AspectFill_Manually: img.size toRect: self.view.bounds];
    rect = [self countRect_ScaleToFill_Manually: img.size toRect: self.view.bounds];
    imgv.frame = rect;
}

- (CGRect)countRect_AspectFit_Manually: (CGSize)fromSize toRect:(CGRect)toRect {
...
- (CGRect)countRect_AspectFill_Manually: (CGSize)fromSize toRect:(CGRect)toRect {
...
- (CGRect)countRect_ScaleToFill_Manually: (CGSize)fromSize toRect:(CGRect)toRect {
    return toRect;
}
